...
const Footer = () => {
  return (
    // Its the curve in footer. Edited and been used in line num 13 to 19
    ...
    //     </svg>
    // </div> */}
    <div className="relative bg-violet-600 mt-40">
<div className="absolute inset-x-0 -top-1">
    <svg viewBox="0 0 224 12" fill="currentColor" className="w-full mt-1 text-white" preserveAspectRatio="none">
        <path d="M0,12.0441132 C48.8902582,5.77097294 86.2235915,2.63440281 112,2.63440281 C137.776408,2.63440281 175.109742,5.77097294 224,12.0441132 L224,0 L0,0 L0,12.0441132 Z">
        </path>
    </svg>
</div>
